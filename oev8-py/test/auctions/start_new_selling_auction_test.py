...
def test_start_new_selling_auction__simply_ok(
    ...
    event_writer_mock.on_trading_provide_item.assert_has_calls([
        call(trd_id=trd_id, cust_id=params.cust_id,
             qty=params.qty, new_qty=params.qty)
    ])
...
def test_start_new_selling_auction__insufficient_for_sec_deposit_amt(
        trading_service: TradingService,
        balance_service,
        item_count_service,
        event_writer_mock,
...
def test_start_new_selling_auction__existing_trd_id(
        trading_service: TradingService,
        balance_service,
        item_count_service,
        event_writer_mock,
...
def test_start_new_selling_auction__zero_sec_deposit_amt(
        trading_service: TradingService,
        balance_service,
        item_count_service,
        event_writer_mock,
    ...
    with raises(CurrencyAmtShouldBePositive):
        trading_service.start_new_selling_auction(**d)
...
def test_start_new_selling_auction__zero_price(
        trading_service: TradingService,
        balance_service,
        item_count_service,
        event_writer_mock,
...
def test_start_new_selling_auction__zero_qty(
        trading_service: TradingService,
        balance_service,
        item_count_service,
        event_writer_mock,
...
def test_start_new_selling_auction__existing_auction_trd_id(
        trading_service: TradingService,
        balance_service,
        item_count_service,
        event_writer_mock,
    ...
    # 담보금 입금.
    total_deposit = params.security_deposit_amt * 2
    ...
    assert balance_service.get(BalanceType.BALANCE,
                               cust_id=params.cust_id,
                               curr=params.curr) == total_deposit
